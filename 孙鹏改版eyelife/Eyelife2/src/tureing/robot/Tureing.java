...
public class Tureing {
	public static String ask(String s) {
		...
		NameValuePair key = new BasicNameValuePair("key",
				"7486312636912ce0a97a729374f7e980");
		...
		try {
			...
			long a3 = System.currentTimeMillis()-a1;
			try {
				long a4 = System.currentTimeMillis()-a1;
				HttpResponse response = httpClient.execute(httpPost);
				long a5 = System.currentTimeMillis()-a1;
				if (response.getStatusLine().getStatusCode() == 200) {
					long a6 = System.currentTimeMillis()-a1;
					HttpEntity entity = response.getEntity();
					long a7 = System.currentTimeMillis()-a1;
					BufferedReader reader = new BufferedReader(new InputStreamReader(entity.getContent()));
					long a8 = System.currentTimeMillis()-a1;
					String line = reader.readLine();
					long a9 = System.currentTimeMillis()-a1;
					//System.out.println("HELLO."+line);
					System.out.println("机器人请求时间:"+a1+":"+a2+":"+a3+":"+a4+":"+a5+":"+a6+":"+a7+":"+a8+":"+a9+":");
					return line;
				}
	...
	/*
	 * public static void main(String [] args[]) { ask("aaa"); }
	 */
}
